...
alter table movie_info add column movie_rating double not null;
alter table movie_info add column movie_review varchar(20) not null;

insert into movie_info values ('1',"Yevudu","Ram","shruti",11111111,1111111,"Action",'2025-01-30',4.5,"Very good movie"),
...
select * from movie_info where actor_name="Ram";                               
select * from movie_info where actor_name="Ram" or actor_name="Adam"; 
select * from movie_info where actor_name="Adam" And actress_name="Eva"; 