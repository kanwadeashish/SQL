...
insert into shelf_six values (1,"Apple",100,"1234abcd",true,'2025-01-30','2025-12-30',8.8),
...
update shelf_six set item_name ="Tennis" where item_id=5;             
update shelf_six set item_price =400 where item_id=5;             
update shelf_six set item_name ="Orange" where item_id=6;             
update shelf_six set item_price =130 where item_id=6;

set autocommit = 0;
insert into shelf_six values (11,"Tomato",35,"1234abcm",true,'2025-01-30','2025-12-30',8.8);    
update shelf_six set item_name = "Drink" where  item_id=7; 

rollback;

commit;
                                
select * from shelf_six;                             