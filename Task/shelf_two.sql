...
insert into shelf_two values (1,"Apple",100,"1234abcd",true,'2025-01-30','2025-12-30',8.8),
...
update shelf_two set item_name ="Tennis" where item_id=5;             
update shelf_two set item_price =400 where item_id=5;             
update shelf_two set item_name ="Orange" where item_id=6;             
update shelf_two set item_price =130 where item_id=6;
             
delete from shelf_two where item_id=10;
delete from shelf_two where item_id=9;
delete from shelf_two where item_id=8;
                                
select * from shelf_two;                             